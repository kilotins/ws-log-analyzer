...
def build_incident_system_prompt(detected_format: str = "", skill_content: str = "",
    ...
    if is_multi_source:
        structure = "\n".join([
            ...
            "",
            "## What Happened",
            "2-3 sentences: what broke, when it started, and what systems are affected. Be technical — this is for the engineer debugging at 2 AM, not a manager.",
            "",
            "## Screenshot Analysis",
            ...
            "",
            "## Affected Systems",
            "Table: System | Status | What's wrong | What to check.",
            "Clearly mark which systems are affected vs. healthy. Include specific log files, ports, hostnames.",
            "",
            "## What To Do Now",
            "Numbered list, prioritized. Include SPECIFIC commands, config changes, SQL queries, or kubectl commands.",
