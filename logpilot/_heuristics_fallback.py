"""Fallback inline heuristic data — used when YAML loading fails (no PyYAML or missing file)."""
...
# --- Correlation rules ---
_CORRELATIONS_INLINE: list[dict[str, Any]] = [
    {
        "id": "corr-oom-pool",
...
_INCIDENT_GROUPS_INLINE: list[dict[str, Any]] = [
    {
